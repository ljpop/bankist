...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const dispDateOrig = new Date(acc.movementsDates[i]);
    const dispDate = `${String(dispDateOrig.getDate()).padStart(2, 0)}/${String(
      dispDateOrig.getMonth() + 1
    ).padStart(2, 0)}/${dispDateOrig.getFullYear()}`;
